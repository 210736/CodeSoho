...
QT_MOC_LITERAL(1, 7, 14), // "ReturnTextEdit"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "MFrame\0ReturnTextEdit\0"
};
...
void MFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MFrame *_t = static_cast<MFrame *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ReturnTextEdit(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject MFrame::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MFrame.data,
      qt_meta_data_MFrame,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MFrame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MFrame.stringdata0))
        return static_cast<void*>(const_cast< MFrame*>(this));
