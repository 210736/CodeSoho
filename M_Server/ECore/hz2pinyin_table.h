#pragma once
namespace ECore{
//! \brief  汉字(Unicode)转拼音对照表,支持多音字
//! \author 整理 by YuHao
//! \ps     汉字unicode编码范围是[0x4e00,0x9fa5],因此取一个汉字拼音为_pinyin_table_[hzCode - 0x4e00]

static LPCSTR _pinyin_table_[20902] = {
    ...
    "ren|lin", "wang", "bin|fen", "di", "fang|pang", "zhong", "qi", "pei", "xu|yu", "diao", \
    ...
    "ba|bei", "die|tu", "ku", "tuo", "jia", "ci|zi", "pao|bo", "qia", "zhu", "qu|ju", \
