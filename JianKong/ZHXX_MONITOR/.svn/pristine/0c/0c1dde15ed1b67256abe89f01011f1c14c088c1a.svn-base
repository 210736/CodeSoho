...
namespace MonitorAndSet.CommonClass
{
    ...
    public class GetSafeData
    {
        ...
        /// <summary>
        /// 从OracleDataReader中安全获取数据
        /// </summary>
        /// <param name="reader">数据读取器OracleDataReader</param>
        /// <param name="colname">列名</param>
        /// <returns>列中的字符串数据，如果为空，则返回System.String.Empty</returns>
        public static string ValidateDataReader_S(OracleDataReader reader, string colname)
        {
        ...
        public static int ValidateDataReader_N(OracleDataReader reader, string colname)
        {
            if (reader.GetValue(reader.GetOrdinal(colname)) != DBNull.Value)
        ...
        public static double ValidateDataReader_F(OracleDataReader reader, string colname)
        {
            if (reader.GetValue(reader.GetOrdinal(colname)) != DBNull.Value)
        ...
        public static DateTime ValidateDataReader_T(OracleDataReader reader, string colname)
        {
            if (reader.GetValue(reader.GetOrdinal(colname)) != DBNull.Value)
